এই মেসেজগুলো আসছে **`sudo mysql_secure_installation`** কমান্ড চলানোর সময়। এটি MySQL সার্ভারকে সিকিউর করার জন্য দেয়া কিছু প্রশ্ন। প্রতিটি প্রশ্নের অর্থ এবং কী করা উচিত সেটা আমি বাংলায় বুঝিয়ে দিচ্ছি:
